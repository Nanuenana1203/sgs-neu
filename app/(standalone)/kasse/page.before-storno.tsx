    ...
    for (const a of arr) {
      ...
      rows.push(
        <button
          ...
          className="rounded-md border border-gray-300 px-1.5 py-1 text-left shadow-sm hover:border-indigo-400 hover:shadow-md transition bg-gray-100 w-full h-14 flex items-center justify-center h-20 overflow-hidden [display:-webkit-box] [-webkit-line-clamp:2] [-webkit-box-orient:vertical]"
      ...
      {!auswahl ? (
        ...
        <div className="rounded-xl border bg-white p-4">
          <div className="flex items-center gap-3">
            ...
            <button
              onClick={() => { setAuswahl(null); setQueryMitglied(""); setQueryArtikel(""); setKorb([]); }}
